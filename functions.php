...
add_action('wp_enqueue_scripts', 'resone_script_enqueue');


// function resone_admin_style() {
// 	wp_enqueue_style('admin-styles', get_template_directory_uri().'/css/admin.css');
//   }

// add_action('admin_enqueue_scripts', 'resone_admin_style');


function resone_theme_setup() {
...
add_action('init', 'resone_theme_setup');
...
// 	);
// }
// add_action('widgets_init', 'resone_widget_setup');
...
// add_editor_style();
// add_editor_style( get_template_directory_uri().'/css/resone-custom-editor-style.css' );
